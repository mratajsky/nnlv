...
class MLPNetworkLimits {
public:
    //
    // Layer count limits
    //
    static constexpr int minHiddenLayers = 0;
    static constexpr int maxHiddenLayers = 3;
    //
    // Neuron count limits
    //
    static constexpr int minInputNeurons = 2;
    static constexpr int maxInputNeurons = 5;
    static constexpr int minHiddenNeurons = 1;
    static constexpr int maxHiddenNeurons = 10;
    ...
    static bool verifyNeuronCount(int count, NetworkLayerInfo::Type layerType) {
        switch (layerType) {
            ...
            case NetworkLayerInfo::Type::Hidden:
                return count >= minHiddenNeurons && count <= maxHiddenNeurons;
